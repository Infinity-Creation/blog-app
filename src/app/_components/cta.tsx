...
export function CallToAction() {
    ...
    return (
        ...
        <section className="bg-transparent lg:mb-[300px] mb-[500px]">
            ...
            <div className=" lg:ml-[-115px] lg:mr-[-200px] ml-[0] mr-[0] absolute lg:mt-[0px] mt-[100px] -translate-x-2/4 -translate-y-2/4 left-2/4 top-2/4 z-1 bg-transparent">
                ...
                /></h1>
                <h2 className="font-600 bg-transparent lg:text-3xl text-2xl md:mr-[300px] mb-[50px] ">
